...
def one_year_of_war():
    ...
    for day in range(1, 366):
        ...
        # В циклах у героев и монстров вызывается метод make_a_move, который должен выбирать и совершать одно
        # действие Для наглядности вы можете добавлять в каждое действие принты с подробностями (чтобы знать кто
        # когда и что совершает) При помощи этой информации вы сможете искать проблемы и ошибки в вашем коде и в
        # конечном итоге это поможет вам улучшить стратегию
        print("\nКоманда добра:\n" + '-' * 50)
